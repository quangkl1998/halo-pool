...
async function main(contract_name) {
  ...
  const instantiateMsg = {
    staked_token: deployerAccount.address,
    reward_token: {
      token: {
        contract_addr:
          "aura17xtm8sfwud9uhr27kaps83eruy4jmptxt8mnj660h6sxju308sfsmq7wfw",
      },
    },
    start_time: 1685615246,
    end_time: 1688120846,
    whitelist: [deployerAccount.address],
  };
